...
void RpcChannel::CallMethod(const MethodDescriptor *method, RpcController *controller, const Message *request, Message *response, Closure *done)
{
...
KVRpcChannel::KVRpcChannel(std::string ip, uint16_t port)
{
...
bool KVRpcChannel::TcpSendMsg(std::string &str)
{
    return false;
}
